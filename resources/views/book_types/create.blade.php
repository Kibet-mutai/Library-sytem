...
@section('content')
    <div class="card card-secondary container p-0 rounded-0">
        <div class="card-header bg-secondary rounded-0">
            <div class="row">
                <h4 class="col-md-10 text-white">Add New Subject/Category</h4>
            </div>
        </div>
        <div class="card-body rounded-0">
            <form action="{{ route('book-types.store') }}" method="post">
                @csrf
                ...
                <div class="form-group row mb-0">
                    ...
                    <div class="col-md-4">
                        <a href="{{ route('book-types.index') }}" class="btn btn-secondary rounded-0 btn-block">Close</a>
                    </div>
                </div>
            </form>
        </div>

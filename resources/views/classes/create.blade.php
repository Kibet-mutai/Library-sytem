...
@section('content')
    <div class="card card-secondary container p-0 rounded-0">
        <div class="card-header bg-secondary rounded-0">
            <div class="row">
                <h4 class="col-md-10 text-white">Add New Class</h4>
            </div>
        </div>
        <div class="card-body rounded-0">
            <form action="{{ route('classes.store') }}" method="post" enctype="multipart/form-data">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-md-6">
                        <textarea id="Description" class="rounded-0 form-control{{ $errors->has('Description') ? ' is-invalid' : '' }}" name="Description">{{ old('Description') }}</textarea>

    ...
    <div class="container">
        ...
        <div class="row">
            <div class="col-md-2 offset-md-6">
                <a href="../../storage/doc_lib/{{$directory->directory_name}}/{{ $file->file }}" class="btn btn-success btn-block rounded-0">Open File</a>
            </div>
            <div class="col-md-2">
                <a href="{{ route('dir_files.edit', $file->id) }}" class="btn btn-secondary btn-block rounded-0">
                    Edit File Name
                </a>
            </div>
            <div class="col-md-2">
                <form method="POST" action="{{route('lib_files.destroy', $file->id)}}">
                    @method('DELETE')
                    {{ csrf_field() }}
                ...
                <div class="card rounded-0">
                    <div class="card-body">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <p><a href="{{ route('library.show', $directory->id) }}" class="color-5 no-text-decoration">{{ $directory->directory_name }} <i class="fas fa-external-link-alt text-dark"></i></a></p>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-md-6">

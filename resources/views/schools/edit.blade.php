...
@section('content')
    <div class="card card-secondary container p-0 rounded-0">
        <div class="card-header bg-secondary rounded-0">
            <div class="row">
                <h4 class="col-md-10 text-white">Edit School Info</h4>
            </div>
        </div>
        <div class="card-body rounded-0">
            <form action="{{ route('schools.update', ['school' => $school->id]) }}" method="post" enctype="multipart/form-data">
                @csrf
                @method('PATCH')
                ...
                <div class="form-group row">
                    ...
                    <div class="col-md-6">
                        <input id="Name" type="text" class="rounded-0 form-control{{ $errors->has('Name') ? ' is-invalid' : '' }}" name="Name" value="{{ $school->Name }}" required autofocus>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-md-6">
                        <input id="PrimaryContact" type="text" class="rounded-0 form-control{{ $errors->has('PrimaryContact') ? ' is-invalid' : '' }}" name="PrimaryContact" value="{{ $school->PrimaryContact }}" required autofocus>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-md-6">
                        <textarea id="Motto" class="rounded-0 form-control{{ $errors->has('Motto') ? ' is-invalid' : '' }}" name="Motto">{{ $school->Motto }}</textarea>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-md-6">
                        <textarea id="PhyiscalLocation" class="rounded-0 form-control{{ $errors->has('PhyiscalLocation') ? ' is-invalid' : '' }}" name="PhyiscalLocation">{{ $school->PhyiscalLocation }}</textarea>
